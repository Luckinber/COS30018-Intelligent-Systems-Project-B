...
def load_data(company, start_date, end_date, data_dir):
	# Creates data directory if it doesn't exist
	if not os.path.isdir(data_dir):
		os.mkdir(data_dir)

	# Shorthand for provided data path and generated filename
	data_file_path = os.path.join(data_dir, f'{company}_{start_date}-{end_date}.csv')

	# Checks if data file with same data exists
	if os.path.exists(data_file_path):
		# If file exists, save as pandas data frame object
		...
		# Save data to data file for loading next run
...
if __name__ == "__main__":
	...
	data = load_data(COMPANY, TRAIN_START, TRAIN_END, 'data')